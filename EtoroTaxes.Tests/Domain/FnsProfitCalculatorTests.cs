...
namespace EtoroTaxes.Tests.Domain;

public class FnsProfitCalculatorTests
{
    private Mock<ICurrencyRateProvider> _currencyRateProvider;
    private Mock<IDividendsProvider> _dividendsProvider;
    private Mock<ITradesProvider> _tradesProviderMock;
    ...
    public void SetUp()
    {
        _tradesProviderMock = new();
        _dividendsProvider = new();
        _currencyRateProvider = new();

        _sut = new(_tradesProviderMock.Object, _dividendsProvider.Object, _currencyRateProvider.Object);
    }
    ...
    public void Calculate_Trades_ShouldSplitByProfitType()
    {
        ...
        var actual = _sut.Calculate(new(2019, 1, 1), new(2019, 5, 1));
    ...
    public void Calculate_Dividends_ShouldBeCorrect()
    {
        ...
        _tradesProviderMock.Setup(t => t.GetTrades()).Returns(Array.Empty<Trade>());

        _dividendsProvider
            .Setup(d => d.GetDividends())
            .Returns(
                new[]
                {
                    new Dividend
